...
target_link_libraries(swipl-win libswipl libplterm ${CMAKE_THREAD_LIBS_INIT} -lz)
target_include_directories(swipl-win BEFORE PRIVATE
			   ${CMAKE_CURRENT_BINARY_DIR}
			   ${CMAKE_CURRENT_SOURCE_DIR})
target_link_options(swipl-win PRIVATE -static)
target_link_options(libswipl PRIVATE -static)
target_link_options(libplterm PRIVATE -static)
